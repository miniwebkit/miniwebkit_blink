...
_tabversion   = '3.4'
_lextokens    = {'EXCEPTION': 1, 'SHORT': 1, 'CONST': 1, 'VOID': 1, 'float': 1, 'NAN': 1, 'STATIC': 1, 'REGEXP': 1, 'DATE': 1, 'NULL': 1, 'TRUE': 1, 'SETTER': 1, 'DOMSTRING': 1, 'CREATOR': 1, 'FALSE': 1, 'UNSIGNED': 1, 'LONG': 1, 'READONLY': 1, 'ELLIPSIS': 1, 'SERIALIZER': 1, 'TYPEDEF': 1, 'OBJECT': 1, 'INFINITY': 1, 'string': 1, 'DICTIONARY': 1, 'SEQUENCE': 1, 'ENUM': 1, 'OCTET': 1, 'INHERIT': 1, 'LEGACYCALLER': 1, 'GETTER': 1, 'integer': 1, 'BYTE': 1, 'OPTIONAL': 1, 'IMPLEMENTS': 1, 'BYTESTRING': 1, 'PARTIAL': 1, 'STRINGIFIER': 1, 'DOUBLE': 1, 'FLOAT': 1, 'OR': 1, 'CALLBACK': 1, 'BOOLEAN': 1, 'ATTRIBUTE': 1, 'INTERFACE': 1, 'UNRESTRICTED': 1, 'identifier': 1, 'ANY': 1, 'DELETER': 1}
_lexreflags   = 0
_lexliterals  = '"*.(){}[],;:=+-/~|&^?<>'
