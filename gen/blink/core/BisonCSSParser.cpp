...
switch (nameLength) {
case 5: {
if (LIKELY((characters[0] | 0x20) == 's' && (characters[1] | 0x20) == 'k' && (characters[2] | 0x20) == 'e' && (characters[3] | 0x20) == 'w' && characters[4] == '(')) {
...
case 6: {
if (LIKELY((characters[0] | 0x20) == 's' && characters[5] == '(')) {
if ((characters[1] | 0x20) == 'c') {
if (LIKELY((characters[2] | 0x20) == 'a' && (characters[3] | 0x20) == 'l' && (characters[4] | 0x20) == 'e')) {
                m_unit = CSSPropertyParser::FNumber;
                m_type = CSSTransformValue::ScaleTransformOperation;
                m_allowSingleArgument = true;
                m_argCount = 3;
}
} else if (LIKELY((characters[1] | 0x20) == 'k')) {
if (LIKELY((characters[2] | 0x20) == 'e' && (characters[3] | 0x20) == 'w')) {
if ((characters[4] | 0x20) == 'x') {
                m_unit = CSSPropertyParser::FAngle;
                m_type = CSSTransformValue::SkewXTransformOperation;
} else if (LIKELY((characters[4] | 0x20) == 'y')) {
                m_unit = CSSPropertyParser::FAngle;
...
case 7: {
if (LIKELY(characters[6] == '(')) {
if ((characters[2] | 0x20) == 'a') {
if (LIKELY((characters[0] | 0x20) == 's' && (characters[1] | 0x20) == 'c' && (characters[3] | 0x20) == 'l' && (characters[4] | 0x20) == 'e')) {
switch ((characters[5] | 0x20)) {
case 'x': {
                m_unit = CSSPropertyParser::FNumber;
...
} else if (LIKELY((characters[2] | 0x20) == 't')) {
if ((characters[0] | 0x20) == 'm') {
if (LIKELY((characters[1] | 0x20) == 'a' && (characters[3] | 0x20) == 'r' && (characters[4] | 0x20) == 'i' && (characters[5] | 0x20) == 'x')) {
                m_unit = CSSPropertyParser::FNumber;
                m_type = CSSTransformValue::MatrixTransformOperation;
                m_argCount = 11;
}
} else if (LIKELY((characters[0] | 0x20) == 'r')) {
if (LIKELY((characters[1] | 0x20) == 'o' && (characters[3] | 0x20) == 'a' && (characters[4] | 0x20) == 't' && (characters[5] | 0x20) == 'e')) {
                m_unit = CSSPropertyParser::FAngle;
...
case 8: {
if (LIKELY(characters[7] == '(')) {
if ((characters[0] | 0x20) == 'r') {
if (LIKELY((characters[1] | 0x20) == 'o' && (characters[2] | 0x20) == 't' && (characters[3] | 0x20) == 'a' && (characters[4] | 0x20) == 't' && (characters[5] | 0x20) == 'e')) {
switch ((characters[6] | 0x20)) {
case 'x': {
                m_unit = CSSPropertyParser::FAngle;
...
} else if (LIKELY((characters[0] | 0x20) == 's')) {
if (LIKELY((characters[1] | 0x20) == 'c' && (characters[2] | 0x20) == 'a' && (characters[3] | 0x20) == 'l' && (characters[4] | 0x20) == 'e' && characters[5] == '3' && (characters[6] | 0x20) == 'd')) {
                m_unit = CSSPropertyParser::FNumber;
...
case 9: {
if (LIKELY((characters[2] | 0x20) == 't' && characters[6] == '3' && (characters[7] | 0x20) == 'd' && characters[8] == '(')) {
if ((characters[0] | 0x20) == 'm') {
if (LIKELY((characters[1] | 0x20) == 'a' && (characters[3] | 0x20) == 'r' && (characters[4] | 0x20) == 'i' && (characters[5] | 0x20) == 'x')) {
                m_unit = CSSPropertyParser::FNumber;
...
case 10: {
if (LIKELY((characters[0] | 0x20) == 't' && (characters[1] | 0x20) == 'r' && (characters[2] | 0x20) == 'a' && (characters[3] | 0x20) == 'n' && (characters[4] | 0x20) == 's' && (characters[5] | 0x20) == 'l' && (characters[6] | 0x20) == 'a' && (characters[7] | 0x20) == 't' && (characters[8] | 0x20) == 'e' && characters[9] == '(')) {
...
case 11: {
if (LIKELY((characters[0] | 0x20) == 't' && (characters[1] | 0x20) == 'r' && (characters[2] | 0x20) == 'a' && (characters[3] | 0x20) == 'n' && (characters[4] | 0x20) == 's' && (characters[5] | 0x20) == 'l' && (characters[6] | 0x20) == 'a' && (characters[7] | 0x20) == 't' && (characters[8] | 0x20) == 'e' && characters[10] == '(')) {
switch ((characters[9] | 0x20)) {
case 'x': {
                m_unit = CSSPropertyParser::FLength | CSSPropertyParser::FPercent;
...
case 12: {
if (LIKELY((characters[7] | 0x20) == 't' && characters[11] == '(')) {
if ((characters[0] | 0x20) == 'p') {
if (LIKELY((characters[1] | 0x20) == 'e' && (characters[2] | 0x20) == 'r' && (characters[3] | 0x20) == 's' && (characters[4] | 0x20) == 'p' && (characters[5] | 0x20) == 'e' && (characters[6] | 0x20) == 'c' && (characters[8] | 0x20) == 'i' && (characters[9] | 0x20) == 'v' && (characters[10] | 0x20) == 'e')) {
                m_unit = CSSPropertyParser::FNumber;
                m_type = CSSTransformValue::PerspectiveTransformOperation;
}
} else if (LIKELY((characters[0] | 0x20) == 't')) {
if (LIKELY((characters[1] | 0x20) == 'r' && (characters[2] | 0x20) == 'a' && (characters[3] | 0x20) == 'n' && (characters[4] | 0x20) == 's' && (characters[5] | 0x20) == 'l' && (characters[6] | 0x20) == 'a' && (characters[8] | 0x20) == 'e' && characters[9] == '3' && (characters[10] | 0x20) == 'd')) {
                m_unit = CSSPropertyParser::FLength | CSSPropertyParser::FPercent;
